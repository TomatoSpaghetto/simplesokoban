...
A lightweight web-based Sokoban engine. 
...
- **Pushing:** Move into a box to push it. You can only push one box at a time, and you cannot pull them.
- **Winning:** The level is complete when every switch has a box on top of it.
- **Reset:** If you get stuck (which happens a lot!), use the **Reset** button to restart the level.
...
- **Sokoban** is a registered trademark of **Falcon Co., Ltd.** This project is a fan-made implementation and is not affiliated with or endorsed by Falcon Co., Ltd.
- All code and logic were developed to be lightweight and accessible for educational and recreational purposes.
